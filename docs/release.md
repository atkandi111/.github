...
If Codex Cloud behavior is unreliable, stop posting top-level trigger comments while continuing to use Issues for reviewed contracts and normal manual development. There is no repository secret, custom queue service, or publisher to disable.
